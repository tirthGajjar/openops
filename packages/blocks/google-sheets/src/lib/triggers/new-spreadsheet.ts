import { createTrigger,blockPropValueSchema,TriggerStrategy } from '@openops/blocks-framework';
...
const polling: Polling<blockPropValueSchema<typeof googleSheetsAuth>, Props> = {
    strategy: DedupeStrategy.TIMEBASED,
    async items({ auth, propsValue, lastFetchEpochMS }) {
        const authValue = auth as blockPropValueSchema<typeof googleSheetsAuth>;
