...
import { createTrigger, TriggerStrategy, blockPropValueSchema, Property } from '@openops/blocks-framework';
...
const polling: Polling<blockPropValueSchema<typeof postgresAuth>, {
    table: {
        table_schema: string,
        table_name: string
    ...
    props: {
        ...
        table: Property.Dropdown({
            ...
            options: async ({ auth }) => {
                ...
                const authProps = auth as blockPropValueSchema<typeof postgresAuth>;
