...
export const pgClient = async (auth: blockPropValueSchema<typeof postgresAuth>, query_timeout = 30000, application_name: string | undefined = undefined , connectionTimeoutMillis = 30000) => {
    const {
        host,
        user,
        database,
