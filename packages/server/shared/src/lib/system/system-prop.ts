...
export enum AppSystemProp {
  ...
  LOAD_TABLES_AND_SUPERSET_MCP_TOOLS = 'LOAD_TABLES_AND_SUPERSET_MCP_TOOLS',
...
export enum SharedSystemProp {
  ...
  INTERNAL_PARALLEL_LOOP_ITERATIONS_LIMIT = 'INTERNAL_PARALLEL_LOOP_ITERATIONS_LIMIT',

  DISABLE_SLACK_INTERACTIONS = 'DISABLE_SLACK_INTERACTIONS',
}
